var owgrDataRaw = require('./owgr011922.json'); //(with path)
var nextTournament = require('./American Express Open.json'); //(with path)
var sgTeeGreenRaw = require('./sgtg011922.json'); //(with path)
